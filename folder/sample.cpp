...
int main() {
    auto start = std::chrono::high_resolution_clock::now();  // เริ่มจับเวลา
    sf::Music bgMusic;
    ...
    while (window.isOpen() && !ST) {
        ...
        if (Mode == 5) {
            ...
            std::chrono::duration<double> elapsed = end - start;   // คำนวณเวลาที่ใช้
            int minutes = static_cast<int>(elapsed.count()) / 60;
            int seconds = static_cast<int>(elapsed.count()) % 60;
            ThxForPlay(minutes, seconds);   // เรียกฟังก์ชันแสดงเวลาที่ใช้
        }
        sf::Event event;
        while (window.pollEvent(event)) {
            if (event.type == sf::Event::Closed) {
        ...
        if (Mode == 1) {
            ...
            if (((player.x == 36 && player.y == 32) || (player.x == 29 && player.y == 2) || (player.x == 20 && player.y == 8) || (player.x == 16 && player.y == 22) || (player.x == 34 && player.y == 20) || (player.x == 24 && player.y == 18) || (player.x == 34 && player.y == 28) || (player.x == 17 && player.y == 32) || (player.x == 20 && player.y == 37)) && !puzzlesolve) {
                PuzzleMain();
                puzzlesolve = true;
        ...
        if (Mode == 2) {
            ...
            if (((player.x == 29 && player.y == 2)|| (player.x == 9 && player.y == 20) || (player.x == 16 && player.y == 20) || (player.x == 5 && player.y == 16) ||(player.x == 24 && player.y == 26) || (player.x == 22 && player.y == 19) || (player.x == 11 && player.y == 34) || (player.x == 38 && player.y == 24) || (player.x == 34 && player.y == 11) || (player.x == 234 && player.y == 26)) && !puzzlesolve) {
                PuzzleMain();
                puzzlesolve = true;
            }
        ...
        //map4
        if (Mode == 4) {
            if (((player.x == 29 && player.y == 5) || (player.x == 28 && player.y == 2) || (player.x == 22 && player.y == 10) || (player.x == 15 && player.y == 22) || (player.x == 34 && player.y == 20) || (player.x == 17 && player.y == 34) || (player.x == 9 && player.y == 20) || (player.x == 20 && player.y == 6) || (player.x == 16 && player.y == 20) || (player.x == 20 && player.y == 26) || (player.x == 10 && player.y == 34) ) && !puzzlesolve) {
                PuzzleMain();
                puzzlesolve = true;
            }
    ...
    for (int i = 0; i < 40; i++) {
        for (int j = 0; j < 40; j++) {
            ...
            if ((i == 1 && j == 13) || (i == 1 && j == 17) || (i == 1 && j == 21) || (i == 1 && j == 27) || (i == 1 && j == 31)
                ...
                || (i == 28 && j > 1 && j < 8) || (i == 28 && j == 9) || (i == 28 && j == 11) || ( 36 && j == 15) || (i == 36 && j == 19) || (i == 36 && j == 21) || (i == 36 && j == 29) || (i == 36 && j == 33)
                ...
                || (i == 38 && j == 2) || (i == 38 && j == 23) || (i == 38 && j == 27) || (i =i == 28 && j == 13) || (i == 28 && j == 15) || (i == 28 && j == 19) || (i == 28 && j == 23) || (i == 28 && j == 25) || (i == 28 && j == 27) || (i == 28 && j == 35)
                ...
                || (i == 36 && j == 4) || (i == 36 && j == 7) || (i == 36 && j == 9) || (i === 38 && j == 31) || (i == 38 && j == 35)
                )
            {
                gameMap[i + j * 40] = 1;
    ...
    for (int i = 0; i < 40; i++) {
        for (int j = 0; j < 40; j++) {
            ...
            if ((i == 1 && j == 8) || (i == 1 && j == 12) || (i == 1 && j == 17) || (i == 1 && j == 19) || (i == 1 && j == 27) || (i == 1 && j == 35)
                ...
                || (i == 6 && j > 1 && j < 5) || (i == 6 && j == 6) || (i == 6 && j == 8) || (i == 6 && j > 9 && j < 13) || (i == 6 && j == 14) || (i == 6 && j == 15) || (i == 6 && j == 17) || (i == 6 && j > 18 && j < 26) || (i == 6 && j > 26 && j < 30) || (i == 6 && j > 30 && j < 34) || (i == 6 && j > 34 && j < 38)
    ...
    for (int i = 0; i < 40; i++) {
        for (int j = 0; j < 40; j++) {
            ...
            if ((i == 1 && (j == 2 || j == 6 || j == 10 || j == 14 || j == 23 || j == 27 || j == 31 || j == 35)) ||
                ...
                (i == 13 && ((j >= 5 && j <= 7) || j == 9 || j == 11 || j == 13 || j == 15 || (j >= 17 && j <= 27) || j == 29 || j == 31 || j == 33 || (j >= 35 && j <= 37))) ||
    ...
    for (int i = 0; i < 40; i++) {
        for (int j = 0; j < 40; j++) {
            ...
            if ((i == 1 && (j == 4 || j == 10 || j == 17)) ||
                ...
                (i == 10 && (j == 4 || j >= 9 && j <= 14 || (j >= 16 && j <= 23) || j == 31 || j == 37)) ||
                ...
                (i == 20 && (j == 7 || j == 11 || (j >= 13 && j <= 15) || j == 17 || (j >= 19 && j <= 21) || j == 23 || j == 27 || j == 31 || j == 33 || j == 35 || j == 37)) ||
