...
int main() {
    ...
    while (window.isOpen() && !ST) {
        ...
        if (Mode == 1) {
            ...
            if (((player.x == 29 && player.y == 2) || (player.x == 20 && player.y == 8) || (player.x == 16 && player.y == 22) || (player.x == 34 && player.y == 20) || (player.x == 24 && player.y == 18) || (player.x == 34 && player.y == 28) || (player.x == 17 && player.y == 32) || (player.x == 20 && player.y == 37)) && !puzzlesolve) {
                PuzzleMain();
                puzzlesolve = true;
        ...
        //map4
        if (Mode == 4) {
            if (((player.x == 29 && player.y == 5) || (player.x == 28 && player.y == 2) || (player.x == 22 && player.y == 10) || (player.x == 15 && player.y == 22) || (player.x == 34 && player.y == 20) || (player.x == 17 && player.y == 34) || (player.x == 20 && player.y == 37) || (player.x == 9 && player.y == 20) || (player.x == 20 && player.y == 6) || (player.x == 16 && player.y == 20) || (player.x == 20 && player.y == 26) || (player.x == 22 && player.y == 19) || (player.x == 10 && player.y == 34) ) && !puzzlesolve) {
                PuzzleMain();
                puzzlesolve = true;
            }
