...
int main() {
    ...
    if (!wallTexture.loadFromFile("brick.png")) {
    ...
    for (int i = 0; i < 40; i++) {
        for (int j = 0; j < 40; j++) {
            ...
            if (
                ...
                gameMap[i + j * 40] = 1;
                displayRects[i + j * 40].setTexture(&wallTexture); // ใช้รูปภาพแทนการเติมสี
            ...
            if ((i == 1 && j == 8) || (i == 1 && j == 12) || (i == 1 && j == 17) || (i == 1 && j == 19) || (i == 1 && j == 27) || (i == 1 && j == 35)
                ...
                || (i == 18 && j > 4 && j < 7) || (i == 18 && j == 8) || (i == 18 && j > 9 && j < 12) || (i == 18 && j == 13) || (i == 18 && j == 15) || (i == 18 && j == 19) || (i == 18 && j == 21) || (i == 18 && j == 23) || (i == 18 && j == 25) || (i == 18 && j == 37)
                || (i == 19 && j > 1 && j < 6) || (i == 19 && j == 8) || (i == 19 && j == 10) || (i == 19 && j == 13) || (i == 19 && j > 14 && j < 18) || (i == 19 && j == 19) || (i == 19 && j == 21) || (i == 19 && j > 22 && j < 30) || (i == 19 && j > 30 && j < 36) || (i == 19 && j > 36 && j < 39)
                || (i == 20 && j == 3) || (i == 20 && j > 6 && j < 12) || (i == 20 && j == 13) || (i == 20 && j == 19) || (i == 20 && j == 21) || (i == 20 && j == 27) || (i == 20 && j == 35)
                || (i == 21 && j > 1 && j < 8) || (i == 21 && j == 11) || (i == 21 && j == 13) || (i == 21 && j > 14 && j < 20) || (i == 21 && j > 20 && j < 26) || (i == 21 && j == 27) || (i == 21 && j == 29) || (i == 21 && j == 31) || (i == 21 && j > 32 && j < 36) || (i == 21 && j > 36 && j < 39)
                ) {
                gameMap[i + j * 40] = 1;
                displayRects[i + j * 40].setTexture(&wallTexture); // กำแพงสีดำ
            }
            if ((i == 22 && j == 2)) {
                gameMap[i + j * 40] = 1;
                displayRects[i + j * 40].setTexture(&wallTexture); // กำแพงสีดำ
